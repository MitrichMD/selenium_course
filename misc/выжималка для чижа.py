...
def selenium_test(link, ver):
    ...
    try:
        ...
        #    vizmi2 = browser.find_element(By.CSS_SELECTOR, ".button_game")
        #    vizmi2.click()
        #    time.sleep(spat2)

        #vizmi2500 = browser.find_element(By.CSS_SELECTOR, ".button_game")
        #vizmi2500.click()
        #time.sleep(5)
        ...
        #    vizmi3 = browser.find_element(By.CSS_SELECTOR, ".button_game")
        #    vizmi3.click()
        #    time.sleep(spat3)
